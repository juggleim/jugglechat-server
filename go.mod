...
require (
	...
	github.com/alibabacloud-go/dm-20151123/v2 v2.3.0
...
require (
	...
	github.com/juggleim/jugglechat-server-ai v1.0.0
...
replace github.com/juggleim/jugglechat-server-ai v1.0.0 => ../jugglechat-server-ai
